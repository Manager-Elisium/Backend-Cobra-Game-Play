...
async function deviceResumedInstantPlay(io, socket, data) {
    try {
        ...
        socket.to(roomId).emit('res:game-resumed-instant-play', {
            status: true,
            message: 'Game resumed by another device',
            gameResumed_In_InstantPlay: {
                ROOM_ID: roomId
            }
        });
        console.log(`   📤 Emitted 'res:game-resumed-instant-play' to room ${roomId} (excluding sender)`);
...
exports.deviceResumedInstantPlay = deviceResumedInstantPlay;
