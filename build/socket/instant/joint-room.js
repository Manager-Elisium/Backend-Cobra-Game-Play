...
async function jointRoomInstantPlay(io, socket, data) {
    try {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    if (!getPlayer.TURN_DECIDE_DECK) {
                        ...
                        await (0, room_instant_play_entity_1.updateAndReturnById)(ID, { TURN_DECIDE_DECK: deck, USERS: getPlayer.USERS });
                        ...
                        let updated = await (0, room_instant_play_entity_1.updateAndReturnById)(ID, { TURN_DECIDE_DECK: deck, USERS: getPlayer.USERS });
