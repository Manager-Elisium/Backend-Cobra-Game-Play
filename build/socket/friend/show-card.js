...
exports.showCardFriendPlay = void 0;
        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    if (isNextRound) {
                        let updated = await (0, room_friend_play_entity_1.updateAndReturnById)(getPlayer?.ID, {
                            TURN_DECIDE_DECK: [],
                            GAME_DECK: [],
                            DROP_DECK: [],
                            CURRENT_DROP_DECK: [],
...
exports.showCardFriendPlay = showCardFriendPlay;
