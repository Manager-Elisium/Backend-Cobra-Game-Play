...
exports.pickCardFriendPlay = void 0;
...
async function pickCardFriendPlay(io, socket, data) {
    try {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    if (IS_NEW_CARD) {
                        ...
                        let updated = await (0, room_friend_play_entity_1.updateAndReturnById)(getPlayer?.ID, { GAME_DECK: deck, DROP_DECK: DROP_DECK, CURRENT_DROP_DECK: [], PREVIOUS_DROP_DECK: getPlayer?.CURRENT_DROP_DECK, USERS: newArray, CURRENT_TURN: nextUserId });
                        ...
                        const DB_CURRENT_DROP_DECK = getPlayer?.CURRENT_DROP_DECK;
                        let updated = await (0, room_friend_play_entity_1.updateAndReturnById)(getPlayer?.ID, { DROP_DECK: DROP_DECK, CURRENT_DROP_DECK: [], PREVIOUS_DROP_DECK: getPlayer?.CURRENT_DROP_DECK, USERS: newArray, CURRENT_TURN: nextUserId });
                        socket.emit('res:pick-card-play-with-friend', {
                            status: true,
                            pickCard_In_FriendPlay: {
                                PICK_CARD,
...
exports.pickCardFriendPlay = pickCardFriendPlay;
