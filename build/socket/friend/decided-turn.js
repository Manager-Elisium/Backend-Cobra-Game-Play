...
exports.decidedFirstRoundTurnFriendPlay = void 0;
...
async function decidedFirstRoundTurnFriendPlay(io, socket, data) {
    try {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    if (highestCard) {
                        ...
                        await (0, room_friend_play_entity_1.updateById)(getPlayer?.ID, { TURN_DECIDE_DECK: null, USERS: upDateRoom.USERS, CURRENT_TURN: highestCard.highestPlayerIndex });
                        io.of('/play-with-friend').in(getPlayer?.ID).emit("res:decided-first-round-turn-play-with-friend", {
                            status: true,
                            firstTurn_In_FriendPlay: {
...
exports.decidedFirstRoundTurnFriendPlay = decidedFirstRoundTurnFriendPlay;
