        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    let updated = await (0, room_lobby_play_entity_1.updateAndReturnById)(ID, { CURRENT_DROP_DECK: CURRENT_DROP_DECK, USERS: newArray });
                    ...
                    socket.emit('res:remaining-card-lobby-play', {
                        status: true,
                        remainingCard_In_LobbyPlay: {
...
exports.dropCardLobbyPlay = dropCardLobbyPlay;
