        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    socket.to(getPlayer?.ID).emit('res:chat-lobby-play', {
                        status: true,
                        chat_In_FriendPlay: {
                            TYPE,
...
exports.chatLobbyPlay = chatLobbyPlay;
