...
exports.leaveNameSpaceLobbyPlay = void 0;
const axios_1 = __importDefault(require("axios"));
const encrypt_1 = require("src/common/encrypt");
const auth_token_1 = require("src/middleware/auth.token");
async function leaveNameSpaceLobbyPlay(io, socket, data) {
    try {
        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                const getUser = await axios_1.default.get(`http://43.204.102.183:3000/user/auth/user-detail`, {
                    headers: {
                ...
                if (!!userDetails) {
                    ...
                    io.of("/")
                        ...
                        .emit("res:leave-namespace-lobby-play", {
                        status: true,
                        leaveNameSpace_In_LobbyPlay: {
                            USER_ID: isAuthorized?.USER_ID,
                        },
                    });
                }
                // io.of("/lobby-play").in(ID).disconnectSockets();
                socket.disconnect();
            }
        }
    }
...
exports.leaveNameSpaceLobbyPlay = leaveNameSpaceLobbyPlay;
