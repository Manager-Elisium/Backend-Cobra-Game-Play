...
async function distributedCardTablePlay(io, socket, data) {
    try {
        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    await (0, room_club_play_entity_1.updateAndReturnById)(ID, { GAME_DECK: randomDeck, USERS: USERS, ROUND_INFO: infoRound });
                }
            }
        }
    }
