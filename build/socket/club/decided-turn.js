...
async function decidedFirstRoundTurnTablePlay(io, socket, data) {
    try {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    if (highestCard) {
                        ...
                        await (0, room_club_play_entity_1.updateAndReturnById)(ID, { TURN_DECIDE_DECK: null, USERS: upDateRoom.USERS, CURRENT_TURN: getPlayer?.USERS[firstTurnPlayer]?.USER_ID });
