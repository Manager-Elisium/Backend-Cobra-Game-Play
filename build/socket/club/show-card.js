        ...
        if (!token) {
            ...
            if (!isAuthorized) {
                ...
                if (!getPlayer) {
                    ...
                    console.log(`PARTICIPATED_USERS :  ${JSON.stringify(infoRound)}`);
                    if (isNextRound) {
                        let updated = await (0, room_club_play_entity_1.updateAndReturnById)(ID, {
                            TURN_DECIDE_DECK: [],
                            GAME_DECK: [],
                            DROP_DECK: [],
                            CURRENT_DROP_DECK: [],
                        ...
                        const cardDistributedPlayer = (cardDistributedLength - 1 + filterUser.length) %
                            filterUser.length;
                        ...
                        const getWinnerCoin = await (0, game_winner_1.clubGameWinner)(getPlayer?.ENTRY_FEES, userIdList);
                        io.of("/club-play")
                            .in(ID)
